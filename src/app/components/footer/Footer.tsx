...
export default function Footer() {
  return (
    <footer className="relative flex px-24 py-7 text-white justify-between bg-gray-900 h-[290px] w-full">
     
      <div className="h-full w-full flex flex-col gap-7 ">
        <b className="text-[40px]">CONNECT</b>
      ...
      <div className="flex flex-col h-full w-full">
        <b className="text-[40px]">Subscribe</b>
