...
export default function Sessions() {
  return (
    <article className="flex flex-col lg:-mt-20 md:mt-20 relative justify-end items-end h-auto font-extrabold text-[40px] ">
      <div className="flex absolute left-16 -top-36">
          <Image
            src="/Logo.png"
            className=""
            height={250}
      ...
      <div className="flex md:w-4/5 relative flex-col font-bold text-[50px] md:text-[70px] mb-6 text-white">
        SESSIONS
        <motion.div
          initial={{ scale: 0 }}
          whileInView={{
      ...
      <div className="flex relative md:w-4/5">
        <div className=" md:justify-start md:items-start justify-center items-center gap-4 flex flex-col">
          ...
          <div className="flex items-end h-full relative justify-center md:justify-start lg:justify-end overflow-hidden md:w-full lg:w-4/5 md:pt-44 lg:pt-12">
            ...
            <p className="text-justify text-[27px] md:text-[37px]  w-4/5 lg:w-3/4">
