...
function MyForm() {
  ...
  return (
    <div className="flex gap-12 flex-col lg:flex-row w-screen h-full lg:h-screen justify-center items-center bg-gray-900">
      <section className="pt-6 px-12 lg:w-1/2 w-full h-full flex flex-col overflow-hidden justify-start items-center bg-[#8b6441] lg:rounded-br-[250px]">
